...
export function CsvImportModal({ onClose, onComplete, currentCount }: CsvImportModalProps) {
  ...
  return (
    ...
    >
      <DialogContent className="bg-card border-border/40 sm:max-w-lg">
        <DialogHeader>
          <DialogTitle id="import-modal-title" className="font-heading text-foreground text-xl">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-muted/40 rounded-lg p-4">
              ...
              <ul className="text-muted-foreground mt-2 space-y-1 text-xs">
                ...
                <li>
                  • Grup valid: <code className="bg-muted rounded px-1 font-mono">family</code>,{' '}
                  <code className="bg-muted rounded px-1 font-mono">friend</code>,{' '}
                  <code className="bg-muted rounded px-1 font-mono">colleague</code>,{' '}
